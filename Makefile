...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Wed May 16 16:57:57 2012
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/home/jose/Desktop/barcodeGui/../../../../usr/local/lib/ -lMagick++ -lMagickCore -lMagickWand -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		decoder.cpp \
		greedyAlgorithm.cpp \
		numbersystemwidget.cpp moc_mainwindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/barcodeGui1.0.0/ && $(COPY_FILE) --parents mainwindow.h fibonacciSystem.h numberSystem.h multiBase.h goldenRatioSystem.h histogramResult.h decoder.h greedyAlgorithm.h numbersystemwidget.h .tmp/barcodeGui1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp multiBase.cpp numberSystem.cpp novelBarcodeDecorder.cpp fibonacciSystem.cpp decoder.cpp greedyAlgorithm.cpp numbersystemwidget.cpp .tmp/barcodeGui1.0.0/ && $(COPY_FILE) --parents mainwindow.ui numbersystemwidget.ui .tmp/barcodeGui1.0.0/ && (cd `dirname .tmp/barcodeGui1.0.0` && $(TAR) barcodeGui1.0.0.tar barcodeGui1.0.0 && $(COMPRESS) barcodeGui1.0.0.tar) && $(MOVE) `dirname .tmp/barcodeGui1.0.0`/barcodeGui1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/barcodeGui1.0.0
...
moc_numbersystemwidget.cpp: numbersystemwidget.h
...
greedyAlgorithm.o: greedyAlgorithm.cpp greedyAlgorithm.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o greedyAlgorithm.o greedyAlgorithm.cpp
