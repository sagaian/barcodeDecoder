...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Thu May 10 01:34:17 2012
# Project:  barcodeGui.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile barcodeGui.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/home/sagaian/workspace/barcodeGui/../../../../usr/local/lib/ -lMagick++ -lMagickCore -lMagickWand -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = main.cpp \
		...
		fibonacciSystem.cpp \
		barcodeDecoder.cpp moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		multiBase.o \
		numberSystem.o \
...
Makefile: barcodeGui.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -o Makefile barcodeGui.pro
...
barcodeDecoder.o: barcodeDecoder.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o barcodeDecoder.o barcodeDecoder.cpp
