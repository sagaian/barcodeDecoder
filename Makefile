...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Sun Jun 10 17:24:05 2012
...
LINK          = g++
LFLAGS        = -m64
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/home/jose/Desktop/Final\ Barcode\ cs194/barcodeDecoder2/../../../../../usr/local/lib/ -lMagick++ -lMagickCore -lMagickWand -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		lucasSystem.cpp \
		code39.cpp \
		powerSystem.cpp moc_mainwindow.cpp \
...
pqFibonacciSystem.o: pqFibonacciSystem.cpp pqFibonacciSystem.h \
		numberSystem.h \
		alphaConverter.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o pqFibonacciSystem.o pqFibonacciSystem.cpp

lucasSystem.o: lucasSystem.cpp lucasSystem.h \
		numberSystem.h \
		alphaConverter.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o lucasSystem.o lucasSystem.cpp

code39.o: code39.cpp code39.h \
		alphaConverter.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o code39.o code39.cpp

powerSystem.o: powerSystem.cpp powerSystem.h \
		numberSystem.h \
		alphaConverter.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o powerSystem.o powerSystem.cpp
